...
class recv_plc(threading.Thread):
    ...
    def __init__(self, ):
        super().__init__()
        MC2CT_url = 'tcp://10.142.1.200:9000'
        ...
        self.MC2CT_sub_socket.setsockopt(zmq.LINGER, 0)
        self.MC2CT_sub_socket.setsockopt(zmq.CONFLATE, 1)
    ...
    def run(self, ):
        while True:
            MCPUB_msg = json.loads(self.MC2CT_sub_socket.recv_string())
