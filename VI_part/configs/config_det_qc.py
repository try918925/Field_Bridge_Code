...
YOLO_CLASSES = ['person', 'qc', 'truck', 'barrier', 'ebox', 'wall', 'zhalan', 'floor'] # notice to be int ['door', 'nodoor']
# YOLO_CLASSES = ['pedestrain']
# ----------------------------------------
CURRENT_DIR = os.path.abspath(os.path.dirname(__file__))
YOLO_NET_CONF = os.path.join(CURRENT_DIR, 'yolov5s.yaml')
YOLO_WEIGHT_PATH = './weights/dacheFzhuang.pt'
YOLO_INFER_SIZE = (640, 640)
YOLO_PADDING_COLOR = (114, 114, 114)
YOLO_THRESHOLD_CONF = 0.4       # 置信度的过滤值
