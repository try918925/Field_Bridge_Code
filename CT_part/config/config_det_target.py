import os
LOG_DIR = "./log"
RESULT_DIR = "./log/lock_result"
if not os.path.exists(RESULT_DIR):
    os.makedirs(RESULT_DIR)
DEBUG = True
# --------------------------------------------------
YOLO_DEVICE = "cuda:0"
YOLO_CLASSES = ['car', 'car_front', 'target', '20_container', '40_container', 'car_board', 'center', 'biaoba', 'lock', 'hanger']
# ----------------------------------------
CURRENT_DIR = os.path.abspath(os.path.dirname(__file__))
YOLO_NET_CONF = os.path.join(CURRENT_DIR, 'yolov5s.yaml')
YOLO_WEIGHT_PATH = './weights/daoban629.pt'
