...
# --------------------------------------------------
YOLO_DEVICE = "cuda:0"
YOLO_CLASSES = ['car', 'car_front', 'target', '20_container', '40_container', 'car_board']  # notice to be int ['door', 'nodoor']
# ----------------------------------------
CURRENT_DIR = os.path.abspath(os.path.dirname(__file__))
YOLO_NET_CONF = os.path.join(CURRENT_DIR, 'yolov5s.yaml')
YOLO_WEIGHT_PATH = './weights/jkyd816.pt'
YOLO_INFER_SIZE = (640, 640)
YOLO_PADDING_COLOR = (114, 114, 114)
YOLO_THRESHOLD_CONF = 0.2    # 置信度的过滤值
